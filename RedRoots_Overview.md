...
|------|----------|-----------|--------|---------------------|
| 1 | **Typed Arrays statt Objekt-Grid** – `Int8Array` statt `{owner, isOld}` Objekte, Double-Buffer-Swap statt Neuallokation. Spieler-IDs verschieben von 0–3 auf 1–4 (0 = leer). | `Grid.js`, alle Dateien | ✅ Umgesetzt | ~3–5× |
...
| 4 | **Buffer-Swap** – Swap von Typed-Array-Referenzen statt `createEmptyGrid()`. Teil von Prio 1. | `Grid.js` | ✅ Umgesetzt (mit Prio 1) | ~2× |
