...
Die Marskarte öffnet weitere Sektoren nach einem Sieg. Zwei optionale Herausforderungen vergeben zusätzliche Sterne; bei Wiederholungen bleibt die beste Wertung erhalten. Genome und PALISADE-Aufzeichnungen werden nach und nach freigeschaltet. Kampagnenfortschritt wird separat unter `redroots_campaign_v1` im lokalen Browserspeicher abgelegt. Gelöschte Browserdaten löschen auch diesen Fortschritt. Laufende Missionen beginnen nach Neuladen von vorn.

Auf der Marskarte findest du unten **Expedition / Spielstand**:

- **Code kopieren**: portabler `RR2`-Code mit allen erreichten Sternwertungen. Auf einem anderen Gerät unter **Übernehmen** einlösen. Die Prüfziffer erkennt Tippfehler; der Code ist bewusst kein geheimes Passwort.
...
- [Geschichte und weitere Akte](docs/CAMPAIGN_STORY.md): durchgehender Handlungsbogen; Akte II–V sind geplant, noch nicht spielbar.
...
`node tests/act2.test.cjs` prüft die fünf neuen Lösungswege, Schutz- und Halteziele sowie Spielstandmigration. Alte lokale Spielstände und RR1-Codes bleiben gültig; neue RR2-Codes übertragen alle zehn Wertungen. Nach Akt I öffnet sich Akt II automatisch.

Akt II setzt die Rettung der Hellas-Siedlungen fort: zwei Versorgungswege, gleichzeitige Schleusenkontrolle, Evakuierung unter Wildwuchs, drei Forschungsarchive und ein gemeinsamer Schutzgürtel. Knappere Budgets, mehrere Ziele und gefährdete Schutzzonen verlangen abgestimmte Conway-Muster. Weitere Akte sind noch nicht spielbar.
